// var company = "google"
// var companyUUID = "6acfa7da-1dbd-936e-d985-cf07a1b27711"
// var company = "farmart"
// var companyUUID = "c30e2e2c-2873-ef6f-c5f1-a2874f20f66f"
// var company = "amazon"
// var companyUUID = "05554f65-6aa9-4dd1-6271-8ce2d60f10c4"
// var company = "apollo-global-management-llc"
// var companyUUID = "84c5275e-2a2f-e43a-1ff1-1a5f7c79975f"
// var company = "nvidia"
// var companyUUID = "ee17319e-f5ee-9c9a-6500-edf82b4fbf05"
// var company = "grofers-trusted-delivery-partner"
// var companyUUID = "79ec9579-eca9-0029-e080-a43ebfea7389"
// var company = "intel"
// var companyUUID = "1e4f199c-363b-451b-a164-f94571075ee5"
// var company = "tencent"
// var companyUUID = "3cae090b-ed2d-95f8-79a9-e32ca480258f"
// var company = "apple"
// var companyUUID = "7063d087-96b8-2cc1-ee88-c221288acc2a"
// var company = "angellist"
// var companyUUID = "55d02c5a-f0d6-f70f-1a04-832633cfce2a"
...
var companyUUID = document.querySelector("#client-app-state").textContent.match(/semrush_summary&q;:{&q;identifier&q;:{&q;uuid&q;:&q;(\w{8}(-\w{4}){3}-\w{12}?)/g)[0].split(";")[6]
...
const fetchTheRest = async (last, cnt) => {
    for (var i = 0; i < cnt; i++) {
        var fetchData = await fetch("https://www.crunchbase.com/v4/data/searches/contacts?source=profile-contacts-card", {
            "credentials": "include",
            "headers": {
...
const grabExperts = async () => {
    ...
    if (data.entities.length < 10) {
        ...
        var lastPersonID = data.entities[9].uuid
        var loopCnt = Math.ceil(data.count / 10)
